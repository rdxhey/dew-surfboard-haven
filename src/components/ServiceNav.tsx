    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          ...
          type="button"
          className="rounded-full w-11 h-11 flex items-center justify-center bg-white/90 hover:bg-gray-100 shadow-md group border border-gray-200 cursor-pointer"
        >
        ...
        <div className="grid grid-cols-3 gap-4">
          {SERVICES.map((svc, i) => (
            <DropdownMenuItem
              ...
              className="flex flex-col items-center hover:bg-gray-100/90 active:bg-gray-200 transition rounded-xl p-2 relative group focus:outline-none cursor-pointer h-auto"
            >
